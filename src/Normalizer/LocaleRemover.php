...
{
    private const string REGEX = '/(?P<prefix>; ?)(?P<lang>a[defgilmoqrstuwxz]|b[abdefghijlmnoqrstvwyz]|c[acdfghiklmnorsuvwxyz]|d[aejkmoz]|e[ceghlnrst]|f[aijkmor]|g[abdefghilmnpqrstuwy]|h[eikmnrtu]|i[delmnoqrst]|j[aemop]|k[eghimnoprwyz]|l[abcgikrstuvy]|m[acdefghklmnopqrstuvwxyz]|n[acefgilopruz]|om|[pP][aefghklmnrstwy]|qa|r[eosuw]|s[abcdeghijklmnorstvxyz]|t[cdfghjklmnortvwz]|u[agkmsyz]|v[aceginu]|w[fs]|y[et]|zh-[hH]ans|z[ahmw])(?P<state>[-_](?:r?[a-zA-Z0-9]{2,3}|1))?(?P<utf>\.utf8|\.big5)?(?P<b>\b-?)(?!:)(?P<end>[;)])/';
