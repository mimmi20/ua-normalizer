...
final class LocaleRemover implements NormalizerInterface
{
    ...
    public function normalize(string $userAgent): string | null
    {
        ...
        $userAgent = preg_replace('/ +xx;/i', '', $userAgent);
