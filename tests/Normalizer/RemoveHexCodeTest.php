...
use UaNormalizer\Normalizer\RemoveHexCode;

final class RemoveHexCodeTest extends TestCase
{
    private RemoveHexCode $normalizer;
    ...
    {
        $this->normalizer = new RemoveHexCode();
    }
