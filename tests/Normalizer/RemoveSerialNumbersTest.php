...
use UaNormalizer\Normalizer\RemoveSerialNumbers;

final class RemoveSerialNumbersTest extends TestCase
{
    private RemoveSerialNumbers $normalizer;
    ...
    {
        $this->normalizer = new RemoveSerialNumbers();
    }
