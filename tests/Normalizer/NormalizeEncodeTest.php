...
use UaNormalizer\Normalizer\NormalizeEncode;

final class NormalizeEncodeTest extends TestCase
{
    private NormalizeEncode $normalizer;
    ...
    {
        $this->normalizer = new NormalizeEncode();
    }
