...
use UaNormalizer\Normalizer\NormalizeWindowsNt;

final class NormalizeWindowsNtTest extends TestCase
{
    private NormalizeWindowsNt $normalizer;
    ...
    {
        $this->normalizer = new NormalizeWindowsNt();
    }
