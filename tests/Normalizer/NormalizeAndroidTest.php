...
use UaNormalizer\Normalizer\NormalizeAndroid;

final class NormalizeAndroidTest extends TestCase
{
    private NormalizeAndroid $normalizer;
    ...
    {
        $this->normalizer = new NormalizeAndroid();
    }
