...
use UaNormalizer\Normalizer\RemoveComment;

final class RemoveCommentTest extends TestCase
{
    private RemoveComment $normalizer;
    ...
    {
        $this->normalizer = new RemoveComment();
    }
