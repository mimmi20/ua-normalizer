...
use UaNormalizer\Normalizer\RemoveTransferEncoding;

final class RemoveTransferEncodingTest extends TestCase
{
    private RemoveTransferEncoding $normalizer;
    ...
    {
        $this->normalizer = new RemoveTransferEncoding();
    }
