...
use UaNormalizer\Normalizer\RemoveBabelFish;

final class RemoveBabelFishTest extends TestCase
{
    private RemoveBabelFish $normalizer;
    ...
    {
        $this->normalizer = new RemoveBabelFish();
    }
