...
use UaNormalizer\Normalizer\RemoveEncryption;

final class RemoveEncryptionTest extends TestCase
{
    private RemoveEncryption $normalizer;
    ...
    {
        $this->normalizer = new RemoveEncryption();
    }
    ...
    public static function userAgentsDataProvider(): array
    {
        return [
            ...
            [
                ...
                'Mozilla/5.0 (X11; Linux x86_64; ru-RU) AppleWebKit/533.3 (KHTML, like Gecko) Leechcraft/0.4.55-13-g2230d9f Safari/533.3',
            ],
        ];
    }
}
