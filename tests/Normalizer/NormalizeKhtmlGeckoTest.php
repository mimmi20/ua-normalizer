...
use UaNormalizer\Normalizer\NormalizeKhtmlGecko;

final class NormalizeKhtmlGeckoTest extends TestCase
{
    private NormalizeKhtmlGecko $normalizer;
    ...
    {
        $this->normalizer = new NormalizeKhtmlGecko();
    }
