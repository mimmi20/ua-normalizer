...
use UaNormalizer\Normalizer\RemoveComdirect;

final class RemoveComdirectTest extends TestCase
{
    private RemoveComdirect $normalizer;
    ...
    {
        $this->normalizer = new RemoveComdirect();
    }
