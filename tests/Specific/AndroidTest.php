    ...
    public function normalizerDataProvider()
    {
        return array(
            ...
            array(
                ...
                '1.0 A70HB' . WurflConstants::RIS_DELIMITER . 'Mozilla/5.0 (Linux; U; Android 1.0.15; xx-xx; A70HB Build/CUPCAKE) AppleWebKit/525.10+ (KHTML, like Gecko) Version/3.0.4 Mobile Safari/523.12.2',
            ),
            array(
                ...
                '2.1 Hero' . WurflConstants::RIS_DELIMITER . 'Mozilla/5.0 (Linux; U; Android 2.1-update1; xx-xx; Hero Build/ERE27) AppleWebKit/525.10+ (KHTML, like Gecko) Version/3.0.4 Mobile Safari/523.12.2',
            ),
            array(
                ...
                '2.2 myTouchHD' . WurflConstants::RIS_DELIMITER . 'Mozilla/5.0 (Linux; U; Android 2.2.1; xx-xx; myTouchHD Build/FRF91) AppleWebKit/533.1 (KHTML, like Gecko) Version/4.0 Mobile Safari/533.1',
            ),
        );
    }
}
